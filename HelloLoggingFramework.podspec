Pod::Spec.new do |spec|
  ...
  spec.name         = "HelloLoggingFramework"
  spec.version      = "1.0.0"
  ...
  spec.source       = { :git => 'https://github.com/ethan-hunt-007/HelloLoggingFramework.git', :tag => '1.0.0' }
  spec.source_files = "HelloLoggingFramework.framework/Headers/*.h"
